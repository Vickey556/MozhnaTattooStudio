...
const allReviews: Review[] = [
  ...
  },
  {
    ...
    date: '3 місяці тому',
    rating: 5,
    text: 'Нещодавно вийшов із салону. Був на сеансі у майстра Надії.\nТату зробили дуже швидко, та й під час запису вчора відповіли майже відразу. Працюють професіонали, тому всім раджу',
    type: 'tattoo'
  }
];
