...
const allReviews: Review[] = [
  {
    ...
    date: 'тиждень тому',
    rating: 5,
    text: 'Задоволена роботою майстра Вікторії.\n Було проведено перекриття шраму за допомогою тату. Вікторія допомогла визначитися з дизайном, розповіла як доглядати. Загоєння минуло без жодних проблем. Рекомендую салон та майстра Вікторію! ✅✅✅',
    type: 'tattoo'
  },
  {
    id: '2',
